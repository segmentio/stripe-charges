...
/**
 * Initialize a new `Charges` the Stripe `key`.
 *
 * @param {String} key
...
function Charges (key, options) {
  if (!(this instanceof Charges)) return new Charges(key, options);
...
Charges.prototype.cohort = function (start, end, callback) {
...
Charges.prototype.charges = function (start, end, callback) {
...
Charges.prototype.query = function (start, end, offset, callback) {
